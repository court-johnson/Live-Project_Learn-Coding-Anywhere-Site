...
<html lang="en">
	<head>
		...
		<title>Staff and Employees of The Tech Academy</title>
	...
	<body class="text-center">
		...
		<div class="container">
			...
			<div class="jumbotron">
				...
				<img class="enlarge2-img" src="images/staff.jpg" alt= "Group picture Tech Academy staff" class="img_fit"/>
			</div>
			
			
			<div class="row tiles">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slideanim margFounders">
					<img class="enlarge-img" src="images/ERIC_1.jpg" alt="Erik Gross" />
					<p></p>
					<p class="lead">Erik Gross<br />Co-Founder</p>
				</div>
				
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slideanim margFounders">
					<img class="enlarge-img" src="images/JACK_1.jpg" alt="Jack Stanley" />
					<p></p>
				...
				<div class="col-lg-4 col-md-3 col-sm-6 col-xs-12 slideanim margBottom">
					<img class="enlarge-img" src="images/Diane.png" alt="Diane Caudle" />
					<p></p>
					<p class="lead">Diane Caudle<br />Receptionist</p>
				</div>
		...
		<div id="myModalPopUp" class="modal fade" role="dialog"> <!-- modal dialog box -->
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<script src="js/staff.js" type="text/javascript">
					</script>
