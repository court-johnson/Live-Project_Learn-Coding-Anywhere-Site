...
<html lang="en">
	<head>
		...
		<title>The Tech Academy Software Developer Boot Camp</title>
	...
	<body class="text-center">
		...
		<div class="container">
			...
			<div  class="jumbotron row">
				<h1 style="padding-left:25px;padding-right:25px;">15 Week Software Developer Boot Camp</h1><br/>
				<div class="justification">
					...
					<p>On the Software Developer Boot Camp, students learn almost ten programming languages and it is considered to be one of the most comprehensive coding boot camp curricula in existence.</p>
					<p>The courses are self-paced and students who study 40 hours a week typically complete the program in 15 weeks. To date, over 95% of all graduates have landed tech jobs.</p><br/>
				</div>
			</div>
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
				<h1 class="jumbotron2">Full list of courses included in the software developer boot camp:</h1><br/>
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseOne" aria-expanded="true" aria-controls="courseOne" id="accHead">
								1. Computer Basics Course
							</a>
						</h4>
					</div>
					<div id="courseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="courseOne">
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseTwo" aria-expanded="true" aria-controls="courseTwo" id="accHead">
								2. WordPress Course
							</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseThree" aria-expanded="true" aria-controls="courseThree" id="accHead">
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseFour" aria-expanded="true" aria-controls="courseFour" id="accHead">
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseFive" aria-expanded="true" aria-controls="courseFive" id="accHead">
								5. HTML &amp; CSS Course
							</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseSix" aria-expanded="true" aria-controls="courseSix" id="accHead">
								6. Visual Studio Course
							</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseSeven" aria-expanded="true" aria-controls="courseSeven" id="accHead">
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseEight" aria-expanded="true" aria-controls="courseEight" id="accHead">
								8. JavaScript Course
							</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseNine" aria-expanded="true" aria-controls="courseNine" id="accHead">
								9. Python Course
							</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseTen" aria-expanded="true" aria-controls="courseTen" id="accHead">
								10. C# & ASP.NET Course
							</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseEleven" aria-expanded="true" aria-controls="courseEleven" id="accHead">
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseTwelve" aria-expanded="true" aria-controls="courseTwelve" id="accHead">
								12. Live Project
							</a>
						</h4>
					</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseThirteen" aria-expanded="true" aria-controls="courseThirteen" id="accHead">
				...
				<div class="panel panel-default bottomAccord">
					<div class="panel-heading" role="tab" id="headingOne">
						<h4 class="panel-title">
							<a role="button" data-toggle="collapse" data-parent="#accordion" href="#courseOptional" aria-expanded="true" aria-controls="courseOptional" id="accHead">
								Optional Courses
							</a>
						</h4>
					</div>
					<div id="courseOptional" class="panel-collapse collapse" role="tabpanel" aria-labelledby="courseOptional">
						<div class="panel-body">
							<p>On top of the 13 courses covered in the Software Developer Boot Camp, we offer several optional courses that graduates can take for an additional cost (please contact us for pricing data): </p>
							<ul class="text-left">
								<li>PHP Course</li>
			...
			<div class="banner row">
                <br/><h3><a href="the-tech-academy-software-developer-boot-camp.php">15 week Software Developer Boot Camp</a></h3>
