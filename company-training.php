...
<body class="text-center">
		...
		<div class = "emp-container">
			<div class = "emp-row">
				...
				<div class = "emp-row-left">
					<br/>
					<p>The Tech Academy is a licensed career school. We offer
					group classes to Portland tech companies to train their
					employees. If you are interested in having your staff trained
					by The Tech Academy in an exact programming language,
		...
		<div>
			<div class="row">
				<div class="col-lg-123" id="contactForm">
					...
					<form method="POST" action="http://plus.allforms.mailjol.net/u/b1749119.php">
						...
						<div class="questions form-group">
							<div id="selectBox">
								<input id="Name" type="text" name="Name" placeholder=" ENTER YOUR COMPANY" class="sixty" required />
							</div>
						</div>
						<div class="questions form-group">
							<div id="selectBox">
